...
func TestConfigureSnapshotSlotConnectionDisablesSnapshotKillingTimeouts(t *testing.T) {
	t.Parallel()
...
func TestConfigureSnapshotSlotConnectionReturnsSettingError(t *testing.T) {
	t.Parallel()
	conn := &recordingSnapshotSlotConnection{failOnQuery: "SET wal_sender_timeout=0"}
